...
#define REGISTER(class_name, ref, func_name, ...)                                           \
    along::RefRegister<class_name, ref> gRefRegister##class_name##func_name(#func_name,     \
    [](class_name *context) -> ref {                                                        \
        return std::bind(&class_name::func_name, context, __VA_ARGS__);                     \
    });

#define REGISTER_NONE(class_name, ref, func_name)                                           \
    along::RefRegister<class_name, ref> gRefRegister##class_name##func_name(#func_name,     \
    [](class_name *context) -> ref {                                                        \
...
#define REGISTER1st(class_name, ref, func_name) \
    REGISTER(class_name, ref, func_name, std::placeholders::_1)

#define REGISTER2nd(class_name, ref, func_name) \
    REGISTER(class_name, ref, func_name, std::placeholders::_1,std::placeholders::_2)
